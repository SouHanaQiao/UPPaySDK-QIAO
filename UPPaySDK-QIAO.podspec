...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of UPPaySDK-QIAO."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/UPPaySDK-QIAO"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "葬花桥" => "wangqiniqan@126.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/UPPaySDK-QIAO.git", :tag => s.version.to_s }
